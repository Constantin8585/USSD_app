...
class sim2ForfaitVoie extends StatefulWidget {
  const sim2ForfaitVoie({super.key});

  @override
  State<sim2ForfaitVoie> createState() => _sim1ForfaitVoieState();
}

class _sim1ForfaitVoieState extends State<sim2ForfaitVoie> {
